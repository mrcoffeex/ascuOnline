                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p style="font-size: 20px;">
                               <center>
                                <span style="font-size: 20px; font-weight: bold;"><i class="fa fa-folder-open"></i> USER ARCHIVE</span><br>
                                </center>
                            </p>
                        </div>
                        <?php  
                            ...
                            <table class="table table-striped table-bordered table-hover" style="width: 100%; margin-bottom: 20px;">
                                ...
                                <tbody>
                                    ...
                                    <tr class="warning">
                                        ...
                                        <td style="font-weight: bold;"><center><?php echo getUserRole($log_row['gy_user_type']) ?></center></td>
