<?php  
    ...
    if (isset($_POST['submit_user'])) {
        ...
        if ($my_password1 != $my_password2) {
            ...
            //insert to database
            $insert_data=$link->query("Insert Into `gy_user`(`gy_user_code`, `gy_full_name`, `gy_username`, `gy_password`, `gy_user_type`) Values('$my_code','$my_name','$my_username','$my_password','$my_role')");

            if ($insert_data) {    
                $my_note_text = $my_name." is added to system users";
