<?php  
    ...
    if (isset($_POST['submit_user_edit'])) {
        ...
        if ($my_password1 != $my_password2) {
            ...
            //insert to database
            $update_data=$link->query("Update `gy_user` SET `gy_user_code`='$my_code',`gy_full_name`='$my_name',`gy_username`='$my_username',`gy_user_type`='$my_role',`gy_password`='$my_password' Where `gy_user_id`='$my_dir_value'");
