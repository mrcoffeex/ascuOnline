<?php
    ...
    if ($my_dir_mode == "normal") {
        ...
        $my_query = "SELECT * From gy_delete Where date(gy_del_date) = CURDATE() ORDER BY gy_del_date ASC LIMIT 0";
    }
?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row" style="margin-top: 0px;">
                        <div class="col-md-12">
                            ...
                            <p>Deleted Items <b><?= $link->query($my_query)->num_rows ?></b> result(s)</p>
