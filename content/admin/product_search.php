                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center p-1">
                                                <a href="edit_product?productId=<?= $product['gy_product_id']; ?>&page=<?= $currPage ?>&pn=<?= $pagenum ?>&search_text=<?= $search_text ?>">
                                                    <button 
                                                    type="button" 
                                                    class="btn btn-info" 
                                            ...
                                            <td class="text-center p-1">
                                                ...
                                                title="click to archive product" 
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" enctype="multipart/form-data" action="convert_item?productId=<?= $product['gy_product_id']; ?>&page=<?= $currPage ?>&pn=<?= $pagenum ?>&search_text=<?= $search_text ?>">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <?php  
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" id="myModalLabel">
                                                            <i class="fa fa-archive fa-fw"></i> Archive <?= $product['gy_product_name'] ?>
                                                        </h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="post" enctype="multipart/form-data" action="product_archive?productId=<?= $product['gy_product_id']; ?>&page=<?= $currPage ?>&pn=<?= $pagenum ?>&search_text=<?= $search_text ?>">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
